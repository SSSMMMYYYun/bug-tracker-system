...
export declare class GetRelationUkSettingResponseBodyResultFormUkSettingsFieldList extends $tea.Model {
    bizAlias?: string;
    fieldId?: string;
    static names(): {
        [key: string]: string;
...
export declare class GetRelationUkSettingResponseBodyResultFormUkSettings extends $tea.Model {
