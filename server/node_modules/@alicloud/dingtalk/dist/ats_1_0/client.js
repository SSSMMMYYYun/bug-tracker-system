...
class ImportJobDataHeaders extends $tea.Model {
    static names() {
        return {
            commonHeaders: 'commonHeaders',
            xAcsDingtalkAccessToken: 'x-acs-dingtalk-access-token',
...
exports.ImportJobDataHeaders = ImportJobDataHeaders;
class ImportJobDataRequest extends $tea.Model {
    static names() {
        return {
            body: 'body',
        };
...
exports.ImportJobDataRequest = ImportJobDataRequest;
class ImportJobDataResponseBody extends $tea.Model {
    static names() {
        return {
            result: 'result',
            success: 'success',
...
exports.ImportJobDataResponseBody = ImportJobDataResponseBody;
class ImportJobDataResponse extends $tea.Model {
    static names() {
        return {
            headers: 'headers',
            statusCode: 'statusCode',
...
exports.ImportJobDataResponse = ImportJobDataResponse;
class QueryCandidatesHeaders extends $tea.Model {
    static names() {
        return {
            commonHeaders: 'commonHeaders',
            xAcsDingtalkAccessToken: 'x-acs-dingtalk-access-token',
...
exports.QueryCandidatesHeaders = QueryCandidatesHeaders;
class QueryCandidatesRequest extends $tea.Model {
    static names() {
        return {
...
exports.QueryCandidatesRequest = QueryCandidatesRequest;
class QueryCandidatesResponseBody extends $tea.Model {
    static names() {
        return {
            hasMore: 'hasMore',
            list: 'list',
...
exports.QueryCandidatesResponseBody = QueryCandidatesResponseBody;
class QueryCandidatesResponse extends $tea.Model {
    static names() {
        return {
            headers: 'headers',
            statusCode: 'statusCode',
...
exports.QueryCandidatesResponse = QueryCandidatesResponse;
...
class ImportJobDataRequestBodyAddress extends $tea.Model {
    static names() {
        return {
            cityCode: 'cityCode',
...
exports.ImportJobDataRequestBodyAddress = ImportJobDataRequestBodyAddress;
class ImportJobDataRequestBodyFullTimeExt extends $tea.Model {
    static names() {
        return {
            salaryMonth: 'salaryMonth',
        };
...
exports.ImportJobDataRequestBodyFullTimeExt = ImportJobDataRequestBodyFullTimeExt;
class ImportJobDataRequestBody extends $tea.Model {
    static names() {
        return {
            address: 'address',
            category: 'category',
...
exports.ImportJobDataRequestBody = ImportJobDataRequestBody;
class QueryCandidatesResponseBodyList extends $tea.Model {
    static names() {
        return {
            candidateId: 'candidateId',
            corpId: 'corpId',
...
exports.QueryCandidatesResponseBodyList = QueryCandidatesResponseBodyList;
...
class Client extends openapi_client_1.default {
     ...
     */
    async importJobDataWithOptions(request, headers, runtime) {
        tea_util_1.default.validateModel(request);
        let realHeaders = {};
        if (!tea_util_1.default.isUnset(headers.commonHeaders)) {
            realHeaders = headers.commonHeaders;
        ...
        return $tea.cast(await this.execute(params, req, runtime), new ImportJobDataResponse({}));
    }
    /**
     * 导入外部渠道发布的职位数据
     *
     ...
     */
    async queryCandidatesWithOptions(request, headers, runtime) {
        tea_util_1.default.validateModel(request);
        let query = {};
        if (!tea_util_1.default.isUnset(request.opUserId)) {
            query["opUserId"] = request.opUserId;
        ...
        if (!tea_util_1.default.isUnset(request.statId)) {
        ...
        return $tea.cast(await this.execute(params, req, runtime), new QueryCandidatesResponse({}));
    }
    /**
     * 查询候选人详情列表
     *
