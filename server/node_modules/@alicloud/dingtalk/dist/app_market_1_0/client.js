...
class NotifyOnCrmDataChangeHeaders extends $tea.Model {
    static names() {
        return {
            commonHeaders: 'commonHeaders',
            xAcsDingtalkAccessToken: 'x-acs-dingtalk-access-token',
...
exports.NotifyOnCrmDataChangeHeaders = NotifyOnCrmDataChangeHeaders;
class NotifyOnCrmDataChangeRequest extends $tea.Model {
    static names() {
        return {
            dataId: 'dataId',
            extension: 'extension',
...
exports.NotifyOnCrmDataChangeRequest = NotifyOnCrmDataChangeRequest;
class NotifyOnCrmDataChangeResponseBody extends $tea.Model {
    static names() {
        return {
            success: 'success',
        };
...
exports.NotifyOnCrmDataChangeResponseBody = NotifyOnCrmDataChangeResponseBody;
class NotifyOnCrmDataChangeResponse extends $tea.Model {
    static names() {
        return {
            headers: 'headers',
            statusCode: 'statusCode',
...
exports.NotifyOnCrmDataChangeResponse = NotifyOnCrmDataChangeResponse;
...
class Client extends openapi_client_1.default {
     ...
     */
    async notifyOnCrmDataChangeWithOptions(request, headers, runtime) {
        tea_util_1.default.validateModel(request);
        let body = {};
        ...
        if (!tea_util_1.default.isUnset(request.operate)) {
        ...
        return $tea.cast(await this.execute(params, req, runtime), new NotifyOnCrmDataChangeResponse({}));
    }
    /**
     * 销售助理CRM数据变更回调通知
     *
     ...
     * @returns NotifyOnCrmDataChangeResponse
     */
    async notifyOnCrmDataChange(request) {
        let runtime = new $Util.RuntimeOptions({});
        let headers = new NotifyOnCrmDataChangeHeaders({});
        return await this.notifyOnCrmDataChangeWithOptions(request, headers, runtime);
    }
    /**
     * 应用市场订单查询
     *
