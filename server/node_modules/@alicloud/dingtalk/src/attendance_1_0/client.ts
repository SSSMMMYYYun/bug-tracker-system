...
export class SalaryThirdDataIntegrationHeaders extends $tea.Model {
  commonHeaders?: { [key: string]: string };
  xAcsDingtalkAccessToken?: string;
  static names(): { [key: string]: string } {
    return {
...
export class SalaryThirdDataIntegrationRequest extends $tea.Model {
  /**
   * @remarks
   * This parameter is required.
   * 
...
export class SalaryThirdDataIntegrationResponseBody extends $tea.Model {
...
export class SalaryThirdDataIntegrationResponse extends $tea.Model {
  headers?: { [key: string]: string };
  statusCode?: number;
...
export class SalaryThirdDataIntegrationRequestItemsBizContents extends $tea.Model {
  /**
   * @example
   * 工作时长
   */
...
export class SalaryThirdDataIntegrationRequestItems extends $tea.Model {
...
export class SalaryThirdDataIntegrationResponseBodyResult extends $tea.Model {
...
export default class Client extends OpenApi {
   ...
   */
  async salaryThirdDataIntegrationWithOptions(request: SalaryThirdDataIntegrationRequest, headers: SalaryThirdDataIntegrationHeaders, runtime: $Util.RuntimeOptions): Promise<SalaryThirdDataIntegrationResponse> {
    Util.validateModel(request);
    let body : {[key: string ]: any} = { };
    if (!Util.isUnset(request.bizType)) {
      body["bizType"] = request.bizType;
    ...
    return $tea.cast<SalaryThirdDataIntegrationResponse>(await this.execute(params, req, runtime), new SalaryThirdDataIntegrationResponse({}));
  }
   ...
   * @returns SalaryThirdDataIntegrationResponse
   */
  async salaryThirdDataIntegration(request: SalaryThirdDataIntegrationRequest): Promise<SalaryThirdDataIntegrationResponse> {
    let runtime = new $Util.RuntimeOptions({ });
