...
export class CancelEventHeaders extends $tea.Model {
  commonHeaders?: { [key: string]: string };
  xClientToken?: string;
  xAcsDingtalkAccessToken?: string;
  static names(): { [key: string]: string } {
...
export class CancelEventRequest extends $tea.Model {
  scope?: string;
  static names(): { [key: string]: string } {
    return {
      scope: 'scope',
...
export class CancelEventResponseBody extends $tea.Model {
  result?: boolean;
  static names(): { [key: string]: string } {
    return {
      result: 'result',
...
export class CancelEventResponse extends $tea.Model {
  headers?: { [key: string]: string };
  statusCode?: number;
...
export default class Client extends OpenApi {
   ...
   */
  async cancelEventWithOptions(userId: string, calendarId: string, eventId: string, request: CancelEventRequest, headers: CancelEventHeaders, runtime: $Util.RuntimeOptions): Promise<CancelEventResponse> {
    Util.validateModel(request);
    ...
    return $tea.cast<CancelEventResponse>(await this.execute(params, req, runtime), new CancelEventResponse({}));
  }
   ...
   * @returns CancelEventResponse
   */
  async cancelEvent(userId: string, calendarId: string, eventId: string, request: CancelEventRequest): Promise<CancelEventResponse> {
    let runtime = new $Util.RuntimeOptions({ });
