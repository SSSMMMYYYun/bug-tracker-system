...
export class CloseTopCardHeaders extends $tea.Model {
  commonHeaders?: { [key: string]: string };
  xAcsDingtalkAccessToken?: string;
  static names(): { [key: string]: string } {
    return {
...
export class CloseTopCardRequest extends $tea.Model {
  /**
   * @remarks
   * This parameter is required.
   * 
...
export class CloseTopCardResponseBody extends $tea.Model {
  result?: boolean;
  success?: boolean;
  static names(): { [key: string]: string } {
    return {
...
export class CloseTopCardResponse extends $tea.Model {
  headers?: { [key: string]: string };
  statusCode?: number;
...
export default class Client extends OpenApi {
   ...
   */
  async closeTopCardWithOptions(request: CloseTopCardRequest, headers: CloseTopCardHeaders, runtime: $Util.RuntimeOptions): Promise<CloseTopCardResponse> {
    Util.validateModel(request);
    ...
    return $tea.cast<CloseTopCardResponse>(await this.execute(params, req, runtime), new CloseTopCardResponse({}));
  }
   ...
   * @returns CloseTopCardResponse
   */
  async closeTopCard(request: CloseTopCardRequest): Promise<CloseTopCardResponse> {
    let runtime = new $Util.RuntimeOptions({ });
